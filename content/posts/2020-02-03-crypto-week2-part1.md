---
title: "Cryptography I: Block Ciphers and Modes of Operation"
...
featured: false
summary: "Week 2-3: Block ciphers, PRP security, one-time key modes (ECB/DET-CTR), many-time key modes (CBC/CTR), IV/nonce-based encryption."
series: ["cryptography-i"]
---

**Why this matters:** Block cipher security is foundational for understanding TLS, disk encryption, and database encryption in real systems.
...
![](/images/posts/construct-inverse.png)
