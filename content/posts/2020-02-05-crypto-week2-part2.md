---
title: "Cryptography I: Advanced Block Cipher Modes and Padding"
...
featured: false
summary: "Practical implementation of CBC and CTR modes: IV management, nonce-based encryption, padding schemes (TLS), and security bounds."
series: ["cryptography-i"]
---

**Why this matters:** Improper IV/nonce handling has led to real breaches (WEP, SSL/TLS downgrades). Critical for secure implementation.
