...
draft: false
author: "z-r0crypt"
description: "Comprehensive catalog of PHP functions exploitable for RCE, file manipulation, and information disclosure in OSWE/AWAE assessments."
categories: ["Web", "Exploit Development"]
tags: ["oswe", "awae", "php", "rce", "web-security", "code-execution"]
featured: false
summary: "PHP functions dangerous when exposed: command execution, code evaluation, callbacks, filesystem manipulation, and information disclosure vectors."
---

**Purpose:** Reference guide for identifying and exploiting PHP vulnerabilities during web application penetration testing.
